...
const Bannner = () => {
    return (
        <div className="featured-item text-white bg-fixed  pt-8 ">
            <div className="text-center mx-auto md:w-4/12 my-8">
                {/* <p className="text-white text-3xl">Welcome to Probiz</p> */}
                <p className="text-3xl uppercase border-b-4 py-2">Elevate your lifestyle with Probiz accessories </p>
            </div>
